...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run bull-regime threshold remediation diagnostics.",
    )
...
def main() -> None:
    ...
    try:
        ...
        print(f"Error: bull regime threshold remediation failed: {exc}")
        sys.exit(1)

    print("QuantPilot-AI Bull Regime Threshold Remediation")
    print("-----------------------------------------------")
